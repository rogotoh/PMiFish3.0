...
#Setting
my ($db, $rarefy, $depth, $denoise, $type);
...
open (OUT1, ">", ".\/Results\/2_4_${as_us}s/${as_us}s_seq.fa") or die("error:$!");
open (OUT2, ">", ".\/Results\/2_4_${as_us}s/${as_us}s_seq_list.txt") or die("error:$!");
open (OUT3, ">", ".\/Results\/2_4_${as_us}s/${as_us}s_table.tsv") or die("error:$!");
